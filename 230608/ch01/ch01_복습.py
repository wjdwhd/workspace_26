...
a = 20 # a의 값은 20이다.
if a == 20: # a가 20인가 ?
# print("a는 20입니다")  # 들여쓰기가 되어있지 않으면 에러 실행이 된다.
...
if a == 10:
print("a는 10입니다 01")  # 코드블럭을 의미하는 들여쓰기가 되어있지 않으면 에러 실행이 된다.
    print("a는 10입니다 02") # 들여쓰기가 되어있어야 정상 실행이 된다.
        print("a는 10입니다 03") # 코드블럭을 의미하는 들여쓰기가 두 번 되어 있어 if 조건문을 넘음으로 에러 실행이 된다.
print("a는 10입니다 03") # 이럴 경우 if 조건문이 끝나고 작동이 된다.
