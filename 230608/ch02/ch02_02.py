...
print(x) # 10
x = "순대국밥" # 순대국밥 -> 변수에 다른 값을 새로 대입할 수 있음
print(x) # 순대국밥
print(type(x)) # <class 'str'>
# ---
# int는 정수(integer), str은 뮨자열(String)에 따옴
...
print(a,b,c) # 33 66 99
# 언팩킹 그거 파이썬 잘하는 취급 X.
x, y, z, w = 7, 14, 21, 28
print(x,y,z,w) # 7 14 21 28
x = 10, 20 # 왼쪽(변수)와 오른쪽(값)의 갯수가 안맞는다면? 다수는 괜찮음
print(x) # 튜플 -> 묶음 데이터.
# x, y = 10, 20, 30
# x, y, z = 10, 20

x = y = z = 10 # -> z = 10 -> y = z (10) -> x = y(z(10))
...
a = a + 20
print(a) # 30 <-- 대소문자와 더불어 가장 많이하는 실수
...
print(a) # 30
'''
- a에는 10이 들어있거, a+=20을 수행하면 a에는 10과 20을 더한 30이 대입.
- +=처럼 산술연산자 (+,-,*,/,...)들에 =을 붙이면 연산결과를 변수에 저장하는 작업
- + = <- 두 연산자 사이에 고백이 있으면 안됨
# a + = 10 (x)
- a += 20, a = a+20을 축약한 형태
'''
