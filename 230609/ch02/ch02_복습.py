...
"""
# 덧셈
print("덧셈", "1 + 1 =", 1 + 1) # 덧셈 1 + 1 = 2
# 뺄셈
print("뺄셈", "1 - 2 =", 1 - 2) # 뺄셈 1 - 2 = -1
# 곱셈
print("곱셈", "2 * 3 =", 2 * 3) # 곱셈 2 * 3 = 6
# 나눗셈
print("나눗셈", "4 / 2 =", 4 / 2) # 나눗셈 4 / 2 = 2.0
# 실수인 것을 어떻게 알까?
print("type(4/2)", type(4 / 2)) # type(4/2) <class 'float'>

"""### 몫 (`//`) 연산자
* 정수끼리 나눗셈 결과가 정수로 나오도록 해야할 때 //로 나눗셈을 하면 됨
* `//`은 버림 나눗셈(floor division)이라고 부르며 나눗셈의 결과에서 소수점 이하는 버림
"""
print("5 / 2 =", 5 / 2, "5 // 2 =", 5 // 2) # 5 / 2 = 2.5 5 // 2 = 2
"""* 참고로 실수에 // 연산자를 사용하면 결과는 실수가 나오며 소수점 이하는 버림.
* 따라서 (연산자 앞뒤 숫자 중 하나라도 실수라면) 결과는 항상 `.0`으로 끝남
"""
"""### 나머지 (`%`) 연산자"""
# 모듈로(modulo) 연산자
print("5 // 2 =", 5 // 2, "5 // 2 =", 5 % 2) # 5 // 2 = 2 5 // 2 = 1
"""### 거듭제곱 (`**`) 연산자"""
print("5 * 2 =", 5 * 2, "5 ** 2 =", 5 ** 2) # 5 * 2 = 10 5 ** 2 = 25
print("5 ** 0.5 =", 5 ** 0.5) # 5 ** 0.5 = 2.23606797749979
"""### 값을 정수로 만들기
